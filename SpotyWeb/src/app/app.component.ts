...
@Component({
    ...
    imports: [CommonModule, RouterOutlet, NavbarComponent, SearchBoxComponent, SearchSongPageComponent, HomePageComponent, SearchAlbumPageComponent, SongsTableComponent]
})
